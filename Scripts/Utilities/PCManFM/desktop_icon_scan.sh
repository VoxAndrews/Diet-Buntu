...
exclude=("snapd-user-session-agent.desktop" "snap-handler.desktop" "gnome-mimeapps.list" "additional-drivers.desktop" "defaults.list" "mimeinfo.cache" "gcr-prompter.desktop" "software-properties-drivers.desktop" "snap-handle-link.desktop" "openjdk-11-java.desktop" "python3.10.desktop" "io.snapcraft.SessionAgent.desktop" "gnome-software-local-file.desktop" "gcr-viewer.desktop" "openstreetmap-geo-handler.desktop" "hplj1020.desktop" "wheelmap-geo-handler.desktop" "google-maps-geo-handler.desktop" "qwant-maps-geo-handler.desktop" "org.kde.kwalletd5.desktop" "software-properties-livepatch.desktop" "info.desktop" "synaptic.desktop" "debian-uxterm.desktop")
